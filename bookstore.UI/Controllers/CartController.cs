...
namespace bookstore.UI.Controllers
{
    ...
    {
        //private readonly List<int> products = new List<int>();
        private readonly IProductService _productService;
        private readonly IHttpContextAccessor _httpContextAncessor;
        private readonly MyDbContext _context;
        

        public CartController(IProductService productService, IHttpContextAccessor httpContextAncessor, MyDbContext context)
        {
