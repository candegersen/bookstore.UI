        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdressSpace = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Neighbourhood = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AppIdentityUserId = table.Column<int>(type: "int", nullable: false),
                    AppIdentityUserId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Address", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Address_AspNetUsers_AppIdentityUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipper_AspNetUsers_AppIdentityUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Address_AppIdentityUserId1",
                table: "Address",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipper_AppIdentityUserId",
                table: "Shipper",
